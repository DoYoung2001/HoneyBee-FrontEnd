...
const MyReserve = () => {
  ...
  const navigate = useNavigate(); // useNavigate 호출하여 navigate 정의
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.contentSection}>
              ...
              <div className={styles.profileSection}>
                ...
                <div className={styles.counselorInfo}>
                  ...
                  <div className={styles.reservationDetail}>
                    {item.date} {item.time}{" "}
                    {item.type === "offline" && `| ${item.location}`}
                  </div>
        ...
        {expandedSections[activeTab].completed &&
          reservations.completed?.map((item) => (
            <div key={item.id} className={styles.reservationCard}>
              <div className={styles.profileSection}>
                <img
                  src="/placeholder-avatar.jpg"
        ...
        {expandedSections[activeTab].canceled &&
          reservations.canceled?.map((item) => (
            <div key={item.id} className={styles.reservationCard}>
              <div className={styles.profileSection}>
                <img
                  src="/placeholder-avatar.jpg"
      ...
      <div className={styles.personalInfoButtonContainer}>
        <button
